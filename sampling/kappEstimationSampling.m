...
%         fluxes_sampling = mean(full(Fluxes.SamplingFluxes),2);
        ...
        fluxes = [fluxes;0]; %﻿add a fake row for tot flux reaction
...
kapp_raw_sampling = struct();
kapp_raw_sampling.values = valuelist;
kapp_raw_sampling.rxn = rxnlist;
kapp_raw_sampling.protein = grlist;
kapp_raw_sampling.condition = rowlist;
kapp_raw_sampling.fluxes = fluxlist;
