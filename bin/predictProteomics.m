...
% maxmu2 = sol2.f;
% clear sol2;
% model2 = changeRxnBounds(model2,'prot_pool_exchange',prot_ub_org*maxmu_org/maxmu2,'u');% adjust global saturation
% fluxes2 = simulateCarbonSource(model2,CSexlist);
% levellist2 = extractProteinLevels(model2,fluxes2,proteinlist);
...
sol4 = optimizeCbModel(model4);
maxmu4 = sol4.f;
clear sol4;
model4 = changeRxnBounds(model4,'prot_pool_exchange',prot_ub_org*maxmu_org/maxmu4,'u');% adjust global saturation
% writeCbModel(model4,'xls','model4.xls');
fluxes4 = simulateCarbonSource(model4,CSexlist);
...
for i = 1:length(rmseCSlist)
    ...
    wholedata = [levellist1(:,idxtmptmp) levellist2(:,idxtmptmp) levellist4(:,idxtmptmp)];
